...
/*
void main() {
	string path = "C:/Users/karth/source/repos/Project1/Project1/Resources/test.png";
	Mat	img = imread(path);
	imshow("Frame", img);
	waitKey(0);
}
...
void main() {
	...
	faceCascade.load("C:/Users/karth/source/repos/Project1/Project1/Resources/haarcascade_frontalface_default.xml");
